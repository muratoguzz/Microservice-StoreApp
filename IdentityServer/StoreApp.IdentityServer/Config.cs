...
namespace StoreApp.IdentityServer
{
    public static class Config
    {
        ...
        public static IEnumerable<Client> Clients => new Client[]
        {
            ...
            new Client
            {
                ClientId="StoreAppVisitorId",
                ClientName="StoreApp Visitor User",
                AllowedGrantTypes=GrantTypes.ClientCredentials, //ClientCredentials grant type kullanır. Bu, kullanıcı doğrulaması yapılmadan sistemin kendi kimliğiyle API'ye erişim sağladığı bir yaklaşımdır.
